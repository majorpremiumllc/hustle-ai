 ...
 * All products tagged with project=tryhustleai for partition isolation.
 */

export const PROJECT_TAG = "tryhustleai";
...
export const PLAN_CONFIG = {
    invoice: {
        name: "AI Invoice",
        monthly: { amount: 2900, interval: "month" },
        yearly: { amount: 27600, interval: "year" }, // $23/mo × 12
    },
    starter: {
        name: "Starter",
...
// Get metadata for Stripe checkout sessions
export function getStripeMetadata(planId, interval = "month") {
    return {
        project: PROJECT_TAG,
        plan: planId,
        interval,
