...
const INDUSTRY_TEMPLATES = {
    ...
    handyman: {
        ...
        qualifier: "What kind of work do you need? Mounting, assembly, repair, drywall, or something else?",
        urgency: "Need it done fast? We often have same-day or next-day availability.",
        upsell: "Since we'll be there, we can tackle any other small projects at the same time — saves you a trip fee!",
        booking: "Let's get you on the schedule. When works best — today or tomorrow?",
        pricing: "Labor is quoted separately. Materials are paid by the customer based on receipt. For clear jobs we give a fixed price; for complex work we provide a range or on-site assessment.",
    },
    electrical: {
...
PRICING (v2 — Autonomous Estimator):
- Labor is quoted separately. Materials paid by customer based on receipt.
- Use FIXED PRICE when scope is clear (quantity + task + normal access).
- Use PRICE RANGE when medium clarity or condition may vary.
- Use ON-SITE ASSESSMENT when troubleshooting/hidden damage/vague scope.
- ${template.pricing || company.aiPricingMsg || "Protect margin. Do NOT underprice."}
- NEVER give a fixed price when scope depends on inspection.

PHOTO HANDLING:
- If no photos and job unclear: ask for 2-4 specific photos (wide shot, close-up, labels, measurements)
- If customer refuses photos: give rough range + recommend on-site assessment

OBJECTION HANDLING:
- "How much?" → Run internal analysis, then give the right pricing format (fixed/range/on-site)
- "I'll think about it" → "No rush! We have openings this week. I can pencil you in and you can always reschedule."
- "Just getting quotes" → "Smart move! Based on what you described, labor would be approximately $X. Materials are separate."
- "Too expensive" → "I understand. Our rate covers the full job with experienced technicians. Want us to come take a look first?"
